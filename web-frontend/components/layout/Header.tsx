  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-4 py-3">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {/* Points Badge */}
          {/* <button className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-card/60 backdrop-blur-xl border border-minimask-border text-sm font-medium hover:bg-secondary transition-colors">
          ...
          <button
            ...
            className={cn(
              ...
              isWalletConnected
                ? 'bg-card/60 backdrop-blur-xl border border-minimask-border hover:bg-secondary'
